  ...
  return (
    <div
      className={classNames(
        "theme-switcher use-transition group fixed bottom-xl left-xl flex h-9xl w-9xl cursor-pointer items-center justify-center rounded-full border-4 border-black shadow-[rgba(13,_38,_76,_0.19)_0px_9px_20px]",
        {
