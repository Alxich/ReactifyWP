...
interface CoockiePolicyProps {}

const CoockiePolicyPage: FC<CoockiePolicyProps> = (props) => {
  return (
    <BlankPageWrapper>
      ...
      <p>
        Please replace "Effective Date: 06/10/2023" and "Discrord / Github /
        Gmail" with the relevant information for your project. Additionally,
        it's crucial to keep your privacy policy up-to-date and in compliance
        with applicable laws and regulations. Consult with legal professionals
        to ensure full compliance with privacy laws in your jurisdiction.
      </p>
    </BlankPageWrapper>
  );
};

export default CoockiePolicyPage;
